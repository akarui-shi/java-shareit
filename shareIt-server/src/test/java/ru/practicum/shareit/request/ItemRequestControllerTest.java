...
public class ItemRequestControllerTest {
    ...
    @Test
    void getItemRequestsByOwnerNoSuchUserExceptionTest() throws Exception {
        long requesterId = 2L;

        when(itemRequestService.getItemRequestsByOwner(anyLong())).thenThrow(new NotFoundDataException("Error"));
    ...
    @Test
    void getItemRequestsAllByOwnerTest() throws Exception {
        long requesterId = 2L;
        long requestId = 2L;
        long itemId = 2L;
        long from = 0;
        ...
        when(itemRequestService.getItemRequestsAllByOwner(requesterId, from, size))
        ...
        verify(itemRequestService).getItemRequestsAllByOwner(requesterId, from, size);
    }

    @Test
    void getItemRequestsAllByOwnerNoSuchUserExceptionTest() throws Exception {
        long requesterId = 2L;
        long from = 0;
        long size = 10;

        when(itemRequestService.getItemRequestsAllByOwner(anyLong(), anyLong(), anyLong()))
    ...
    @Test
    void getItemRequestByIdNoSuchUserExceptionTest() throws Exception {
        long requesterId = 2L;
        long requestId = 1L;

        when(itemRequestService.getItemRequestById(anyLong(), anyLong())).thenThrow(new NotFoundDataException("Error"));
    ...
    @Test
    void getItemRequestByIdNoSuchItemRequestExceptionTest() throws Exception {
        long requesterId = 2L;
        long requestId = 1L;
